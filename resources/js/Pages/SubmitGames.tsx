...
export default function SubmitGame () {
    ...
    const oneTimePageThreeCheck = useRef<boolean>(false)
    const oneTimePageFourCheck = useRef<boolean>(false)
    ...
    const checkAnswers = (page:number) => {
        switch (page) {
            ...
            case 2:
                ...
                break
            case 3:
                if (oneTimePageThreeCheck.current === false) {
                    if (
                        data.steam === "" &&
                        data.epic === "" &&
                        data.gog === "" &&
                        ...
                        setError(
                            "platforms",
                            "You have not entered the link to any platforms. While none of these are mandatory informations, consider again if you really don't have this information"
                        )
                        oneTimePageThreeCheck.current = true
                        return
                    } else {
                        oneTimePageThreeCheck.current = true
                    }
    ...
    function handleSubmit(e:any) {
        ...
        if (oneTimePageFourCheck.current === false) {
            if (
                data.twitter === "" &&
                data.facebook === "" &&
                data.instagram === "" &&
                ...
                oneTimePageFourCheck.current = true
                return
            } else {
                oneTimePageFourCheck.current = true
            }
    ...
    return(
        <Layout>
            ...
            <section className="max-w-[1200px] m-auto grow flex flex-col p-4 gap-2">
            {
                isSubmitted 
                ? <div className="flex w-full grow justify-center items-center">
                    <h1 className="text-xl">Game has been submitted! We will review the game and if everything is alright it will be published soon!</h1>
                </div>
                : <>
